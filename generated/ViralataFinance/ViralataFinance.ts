...
export class ViralataFinance extends ethereum.SmartContract {
  static bind(address: Address): ViralataFinance {
    return new ViralataFinance("ViralataFinance", address);
  }
